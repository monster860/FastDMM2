	...
	constructor(editor, error = null) {
        ...
        if(window.chooseFileSystemEntries) {
            ...
            button_elem.addEventListener("click", async () => {
                ...
                try {
                    is_open_busy = true;
                    // TODO: the standard says "open-directory" not "openDirectory" but the chrome implementation is wrong. Fix when chrome fixes implementation.
                    let dir_handle = await window.chooseFileSystemEntries({type: "openDirectory"});
