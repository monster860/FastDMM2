	...
	handle_global_hotkey(e) {
		if(e.code == "KeyV" && e.ctrlKey) {
			navigator.clipboard.readText().then(text => {
				...
				info.float_offset_x = (this.editor.map_window.mouse_x || dmm.mapwindow_x) - Math.floor(float_dmm.maxx / 2);
				info.float_offset_y = (this.editor.map_window.mouse_y || dmm.mapwindow_y) - Math.floor(float_dmm.maxy / 2);
				info.float_offset_z = (this.editor.map_window.mouse_z || dmm.mapwindow_z) - float_dmm.maxz;
				this.editor.map_window.draw_dirty = true;
