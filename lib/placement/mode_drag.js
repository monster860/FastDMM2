...
class HandlerPixelDrag extends PlacementHandler {
	...
	mousemove_pixel(tile) {
		...
		if(dx != 0 && this.replacement_instance.get_var("pixel_x") == this.replacement_instance.type_obj.get_var("pixel_x")) {
			this.replacement_instance.vars.delete("pixel_x");
		}
		if(dy != 0 && this.replacement_instance.get_var("pixel_y") == this.replacement_instance.type_obj.get_var("pixel_y")) {
